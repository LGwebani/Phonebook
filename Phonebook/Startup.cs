...
namespace Phonebook.App
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IErrorLogger, ErrorLogger<Startup>>();
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            {
                FileProvider = new PhysicalFileProvider(Path.Combine(Directory.GetCurrentDirectory(), @"Scripts/App")),
                RequestPath = new PathString("/Scripts/App")
            });
            app.UseCookiePolicy();
